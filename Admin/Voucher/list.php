    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><a href="?btn_change=<?= $item['id_voucher'] ?>" class="fas fa-undo"></a><a href="?btn_edit=<?= $item['id_voucher'] ?>" class="fas fa-edit m-2"></a><a onclick="return alter_delete()" href="index.php?btn_delete=<?= $item['id_voucher'] ?>" style="cursor: pointer;" class="fas fa-trash-alt text-danger"></a></td>
            </tr>
        <?php
        }
        ?>
